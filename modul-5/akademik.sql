...
--
-- Host: localhost
-- Waktu pembuatan: 13 Okt 2022 pada 05.09
...
CREATE TABLE `nilai` (
  ...
  `kode_guru` varchar(20) NOT NULL,
  `kode_sk` varchar(20) NOT NULL,
  `nilai_angka` varchar(20) NOT NULL,
  `nilai_huruf` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
ALTER TABLE `nilai`
  ADD KEY `nilai_ibfk_1` (`kode_sk`),
  ADD KEY `nilai_ibfk_2` (`kode_guru`),
  ADD KEY `nilai_ibfk_3` (`nisn`);
...
--
ALTER TABLE `nilai`
  ADD CONSTRAINT `nilai_ibfk_1` FOREIGN KEY (`kode_sk`) REFERENCES `standar_kompetensi` (`kode_sk`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `nilai_ibfk_2` FOREIGN KEY (`kode_guru`) REFERENCES `guru` (`kode_guru`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `nilai_ibfk_3` FOREIGN KEY (`nisn`) REFERENCES `siswa` (`nisn`) ON DELETE NO ACTION ON UPDATE CASCADE;
