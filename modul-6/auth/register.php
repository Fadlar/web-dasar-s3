...
<head>
  ...
  <title>Register - Belajar PHP</title>
    ...
    <div class="card rounded-4 border-0 p-3 width">
      <div class="card-body">
        <div class="mb-4">
          ...
          <small class="text-muted">Sudah mendaftar ? <a href="login.php" class="text-primary text-decoration-none fw-semibold">Masuk</a> ke akun Anda.</small>
        </div>
