    ...
    <div class="card rounded-4 border-0 p-3 width">
      <div class="card-body">
        <div class="mb-4">
          ...
          <small class="text-muted">Tidak punya akun ? <a href="register.php" class="text-primary text-decoration-none fw-semibold">Register</a>.</small>
        </div>
