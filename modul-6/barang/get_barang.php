...
<head>
  ...
  <title>Get Barang - Belajar PHP</title>
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td class="text-end">
                  <a href="update_barang.php?id=<?= $b['id'] ?>" class="text-decoration-none text-white badge bg-success">Edit</a>
                  <a href="process_barang.php?id=<?= $b['id'] ?>&action=delete" class="text-decoration-none text-white badge bg-danger">Hapus</a>
                </td>
              </tr>
            <?php
            }
