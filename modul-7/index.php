...
<head>
  ...
  <title>Tugas Pertemuan 7 - Belajar PHP</title>
  <link href="dist/output.css" rel="stylesheet">
</head>

<body class="min-h-screen tracking-tighter text-slate-800 bg-slate-50">
  <header class="text-center">
    <h2 class="text-4xl font-semibold pt-10">Tugas Pertemuan <span class="animate-pulse">7</span></h2>
    <div class="mt-2">
  ...
  <main class="w-full px-3 mt-10">
    ...
    <footer class="py-4 w-full text-center mt-10 text-sm h-full">
      Create by <a href="http://github.com/fadlar" class="text-cyan-600 font-medium font-mono">@Fadlar</a>
    </footer>
  </main>
</body>
